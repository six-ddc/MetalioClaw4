...
#ifndef XINGZHI_395_USE_FL7707N
#define XINGZHI_395_USE_FL7707N 0
#endif

#if XINGZHI_395_USE_FL7707N
...
static esp_lcd_panel_io_handle_t s_xingzhi_panel_io = NULL;

extern "C" esp_lcd_panel_io_handle_t xingzhi_395_get_panel_io() { return s_xingzhi_panel_io; }
...
static i2c_master_bus_handle_t s_xingzhi_i2c_bus = NULL;

extern "C" i2c_master_bus_handle_t xingzhi_395_get_i2c_bus() { return s_xingzhi_i2c_bus; }
...
class XINGZHI_395 : public DualNetworkBoard {
private:
    ...
    // XINGZHI_395_USE_FL7707N == 0 时把它替换为本函数。
    ...
    static void I2cWxchoTask(void* arg) {
        XINGZHI_395* board = static_cast<XINGZHI_395*>(arg);
        if (board == nullptr) {
...
public:
    XINGZHI_395() : DualNetworkBoard(NT26_TX_PIN, NT26_RX_PIN, NT26_MRDY_PIN, NT26_SRDY_PIN, 1) {
        InitializeI2C();
        ...
        xTaskCreate(
            [](void* pvParameters) {
                ...
                while (1) {
                    ...
                    // （xingzhi-395 的 DualNetworkBoard 这一路只接 NT26），
